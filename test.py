...
class FileWatcherApp:
    ...
    def add_watcher(self):
        ...
        if folder:
            watcher = {'folder': folder, 'status': 'stopped'}
    ...
    def load_config(self):
        try:
            ...
            # Behandel de JSONDecodeError, bijvoorbeeld door een lege lijst als standaardwaarde in te stellen
            self.watchers = []


    def save_config(self):
        # Verwijder de 'observer'-sleutel voordat je opslaat
